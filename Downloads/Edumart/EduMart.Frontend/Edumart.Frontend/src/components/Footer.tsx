      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">{t('footer.aboutDesc')}</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">{t('footer.faqs')}</a></li>
          ...
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">{t('footer.connect')}</h3>
